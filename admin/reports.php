...
function rbadge($s)
{
  $m = ['pending' => ['badge-pending', '⏳'], 'approved' => ['badge-approved', '✅'], 'rejected' => ['badge-rejected', '❌'], 'rescheduled' => ['badge-rescheduled', '📅']];
  [$c, $i] = $m[$s] ?? ['', ''];
  return "<span class='badge $c'>$i " . ucfirst($s) . "</span>";
}
...
<div class="page-hdr">
  <div>
    ...
    <div class="page-sub">System-wide appointment statistics and insights.</div>
  </div>
</div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
  ...
  <div class="card">
    <div class="card-hdr">📅 Monthly Appointments</div>
    <div class="card-body">
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
  <div class="card">
    <div class="card-hdr">📄 Requests by Document Type</div>
    <div class="card-body">
  ...
  <div class="card">
    <div class="card-hdr">📊 Status Breakdown (%)</div>
    <div class="card-body">
      <?php foreach ([
        ['Approved', $t['approved'], '#198754'],
