...
<div class="page-hdr">
  <div>
    <div class="page-title">👥 Registered Residents</div>
    <div class="page-sub">All residents registered in the system.</div>
  </div>
</div>

<form method="GET" style="display:flex;gap:10px;margin-bottom:16px;">
  <input type="text" name="q" class="fc" placeholder="🔍 Search by name, email, or phone..." value="<?= e($search) ?>"
      ...
      <tbody>
        <?php foreach ($residents as $r): ?>
          <tr>
            ...
            <td><?= e($r['address']) ?></td>
            <td>
              <?= $r['is_verified'] ? "<span class='badge badge-approved'>✅ Verified</span>" : "<span class='badge badge-rejected'>❌ Unverified</span>" ?>
            </td>
