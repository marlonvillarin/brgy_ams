...
<div class="stats-grid" style="grid-template-columns:repeat(auto-fit,minmax(120px,1fr));">
  <?php foreach ([
    ['Total', '📁', $stats['total'], '#003087'],
    ['Pending', '⏳', $stats['pending'], '#856404'],
    ['Approved', '✅', $stats['approved'], '#198754'],
    ['Rejected', '❌', $stats['rejected'], '#dc3545'],
    ['Rescheduled', '📅', $stats['rescheduled'], '#0d6efd'],
    ['Deleted', '🗑️', $deleted_count, '#6c757d'],
  ] as [$l, $i, $v, $c]): ?>
...
<div id="viewModal" class="modal-overlay">
  <div class="modal-box">
    <div class="modal-hdr">
      ...
      <button class="modal-close" onclick="document.getElementById('viewModal').classList.remove('show')">×</button>
    </div>
